...
const CopyEmailButton = () => {
    ...
    const email = "assknid.walid01@gmail.com";
  ...
  return (
    <motion.button className={copied ? ("relative px-1 py-4 text-sm text-center rounded-full font-extralight bg-gray-500 w-[12rem] cursor-pointer overflow-hidden") :
